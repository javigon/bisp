...
\begin{frame}
  ...
  \vspace{3mm}\begin{center}
    \scalebox{0.8}{\includeSVG{mediumleveloverview}}
  \end{center}
...
\begin{frame}
  ...
  \begin{itemize}
    \item We have a real-time simulator at \url{gsd.itu.dk}
    \item You are welcome to deploy/install/setup your own for accelerated testing \ldots
    \item Links:
    \begin{itemize}
      \item Documentation: \\
