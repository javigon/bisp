...
Even when it might sound like an intricate way of mapping services to buildings and ultimately to a simulation, the design is very simple. (ADD FIGURE). Besides, this design is flexible enough as to allow changing and adding building layouts and instances without worrying about the simulator running on top of it.
