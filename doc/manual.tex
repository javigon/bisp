...
\begin{figure}[htb]
  \begin{center}
    \rotatebox{0}{\scalebox{1.0}{\includegraphics[scale=1.0]{figs/demo_temp.pdf}}}
  \end{center}
...
The building layout can be modified, and more buildings can be added to the simulation too. It is \texttt{bif/building/bmanager.py} that handles the building physical layouts, instantiate them and connect them to the simulator.
